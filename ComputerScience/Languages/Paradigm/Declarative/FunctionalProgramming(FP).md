...
Независимо от Алонзо, [Алан Тьюринг](https://www.youtube.com/watch?v=3GKaT-rUwF4) проводил подобное исследование. Он разработал другую формальную систему (которую сейчас называют [Машиной Тьюринга](https://www.youtube.com/watch?v=3GKaT-rUwF4)), и используя её пришёл к выводам, подобным Алонзо. Позже было доказано, что машина Тьюринга и лябда-исчисление имеют [одинаковую мощность](https://cstheory.stackexchange.com/a/637).
