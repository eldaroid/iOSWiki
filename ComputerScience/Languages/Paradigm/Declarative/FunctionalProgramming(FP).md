...
Независимо от Алонзо, [Алан Тьюринг](https://github.com/eldaroid/iOSWiki/blob/master/Memory%20and%20Concurrency/Memory/RandomAccessMemory/RAM.md#алан-тьюринг-и-ram) проводил подобное исследование. Он разработал другую формальную систему (которую сейчас называют [Машиной Тьюринга](https://github.com/eldaroid/iOSWiki/blob/master/Memory%20and%20Concurrency/Memory/RandomAccessMemory/RAM.md#алан-тьюринг-и-ram)), и используя её пришёл к выводам, подобным Алонзо. Позже было доказано, что машина Тьюринга и лябда-исчисление имеют [одинаковую мощность](https://cstheory.stackexchange.com/a/637).
...
### [Композиция](/ComputerScience/Patterns/DesignPattern/Structural/Composite.md)

Почитать дополнительно можно [здесь](/ComputerScience/Patterns/DesignPattern/Structural/Composite.md)
...
В функциональной программе всё состояние хранится в стеке в виде аргументов функций, поэтому функциональная программа сразу готова к распараллеливанию без каких-либо изменений. Вам не придётся задумываться о [deadlock-ах](/Memory%20and%20Concurrency/Concurrency/ProblemsOfConcurrency.md) или состояниях гонки ([race conditions](/Memory%20and%20Concurrency/Concurrency/ProblemsOfConcurrency.md)) потому что вам не нужны блокировки! Ни один кусочек данных в функциональной программе не меняется дважды одним и тем же потоком или разными. Это означает, что вы можете легко добавить потоков к вашей программе даже не задумываясь при этом о проблемах, присущих императивным языкам.
