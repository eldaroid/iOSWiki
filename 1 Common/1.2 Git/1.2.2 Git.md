...
[Спецификация Conventional Commits 1.0.0 для добавления понятного человеку и машине значения о фиксации сообщения](https://www.conventionalcommits.org/en/v1.0.0/). Вкратце:
...
[1.2.1 Markdown Theme](./1.1.1%20Markdown.md) | [Back To iOSWiki Contents](https://github.com/eldaroid/iOSWiki) |  [1.2.3 GitFlow Theme](./1.2.3%20Flow/)
