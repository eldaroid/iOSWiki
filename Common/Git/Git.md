...
<p>
  ...
  > **git fetch** - Получает _список изменений_ в удаленном репозитории, а также сами изменения, без слияния с вашими изменениями
...
>   * -- oneline - выводит сокращённые данные коммита (в виде одной строки);
  ...
  * [git reflog](https://git-scm.com/book/ru/v2/Git-изнутри-Обслуживание-репозитория-и-восстановление-данных#:~:text=git%20reset) - во время вашей работы при переключении веток и коммитов изменений, Git записывает все изменения HEAD в reflog.
...
[Previous Theme](/Common/DesignPattern) | [Back To Contents](https://github.com/eldaroid/iOSWiki) |  [Next Theme](/Common/Git/Gitflow.md)
