...
>   * -- oneline - выводит сокращённые данные коммита (в виде одной строки);
  ...
  * [git reflog](https://git-scm.com/book/ru/v2/Git-изнутри-Обслуживание-репозитория-и-восстановление-данных#:~:text=git reset) - во время вашей работы при переключении веток и коммитов изменений, Git записывает все изменения HEAD в reflog.
