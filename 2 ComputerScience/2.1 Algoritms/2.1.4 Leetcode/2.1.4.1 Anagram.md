...
№3 - положить содержимое строк в [ассоциативный массив/словарь](/5%20Swift/5.3%20DataRepresentations/5.3.1%20DataTypes/5.3.1.4%20ValueTypes/5.3.1.4.4%20CollectionsAndTuple/5.3.1.4.4.2%20AssociatedArray.md) и сравнить содержимое массивов для двух строк. Время выполнения алгоритма [линейная](../2.1.2%20ListOfAlgoritms.md), поскольку нам не требую тся дополнительные вычисления в виде сортировки.
...
[2.1.3 Operators Theme](../2.1.3%20Operators/) | [Back To iOSWiki Contents](https://github.com/eldaroid/iOSWiki) | [2.1.4.2 Count Chart In String Theme](./2.1.4.2%20CountCharInStr.md)
