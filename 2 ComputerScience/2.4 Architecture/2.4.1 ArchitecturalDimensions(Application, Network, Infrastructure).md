...
Web serverпрограмма, которая использует протокол **HTTP (Hypertext Transfer Protocol)** для предоставления пользователям статических файлов в ответ на их запросы.

Если веб-сервер получает запрос на предоставление **статического** HTML, CSS или JavaScript файла, он просто возвращает запрошенный файл.
...
* Web Application (Веб-приложение) Server
...
Если вы знакомы с Ruby on Rails, вы, вероятно, слышали о Unicorn, Rainbows, и Puma. Это очень широко используемые серверные программы для приложений Rails.
