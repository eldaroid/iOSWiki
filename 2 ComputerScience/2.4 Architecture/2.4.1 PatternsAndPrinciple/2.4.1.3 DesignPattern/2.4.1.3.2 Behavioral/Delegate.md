...
Делегирование — это концепция, которая в основном используется в протокольно-ориентированном программировании ([POP](/2%20ComputerScience/2.2%20Languages/2.2.2%20Paradigm/2.2.2.2%20Imperative/2.2.2.2.3%20POP.md))
