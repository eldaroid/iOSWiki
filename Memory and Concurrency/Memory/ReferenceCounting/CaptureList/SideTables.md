...
Обычно объекты не имеют абстрактного понятия [слабых ссылок](./Weak.md), поэтому резервировать место для подсчета [слабых ссылок](./Weak.md) в каждом объекте нецелесообразно. Эта информация хранится извне в дополнительных таблицах, поэтому ее можно выделить только тогда, когда это действительно необходимо.
