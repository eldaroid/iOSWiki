...
Однако, 128 символов это 2^7, но почему тогда 8 бит это один байт? Нижнюю половину кодовой таблицы (0—127) занимают символы ASCII, а верхнюю (128—255) — дополнительные символы, включая набор национальных символов. Оригинальный же ASCII расширяют до 8 бит, просто добавляя 1 нулевой бит в качестве старшего.
