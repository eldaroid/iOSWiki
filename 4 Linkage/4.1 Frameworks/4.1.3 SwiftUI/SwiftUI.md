...
🟣 3. Composition over Inheritance. [Композиция](/2%20ComputerScience/2.4%20Architecture/2.4.1%20Patterns/2.4.1.3%20DesignPattern/2.4.1.3.4%20Structural/Composite.md) важнее [наследования](/2%20ComputerScience/2.2%20Languages/2.2.2%20Paradigm/2.2.2.2%20Imperative/2.2.2.2.2%20OOP.md). Разрабам из UIKit немного сложнее в этом вариться, так как мы привыкли наследоваться от UITableView, UITableViewCell и многих других элементов. В SwiftUI же акцент сделан в другую сторону
